...
const UpdateCoffee = () => {
  ...
  const { _id, name, chef, supplier,taste, category, details, price, photos } = coffee;
  ...
  const handleUpdateCoffee = (event) => {
    ...
    fetch(`https://coffee-store-server-pi-lac.vercel.app/coffee/${_id}`, {
      method: "PUT",
      headers: {
    ...
    <div>
      <div>
        ...
        <div className="grid gap-6 bg-[#F4F3F0] p-6">
          <div className="">
            <h2>Update Coffee: <span>{name}</span> </h2>
          </div>
          <form onSubmit={handleUpdateCoffee}>
            <div className="grid gap-6 mb-6 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  type="text"
                  id="details" defaultValue={details}
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
